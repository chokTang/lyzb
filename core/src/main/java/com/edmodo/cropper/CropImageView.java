...
public class CropImageView extends ImageView {
    ...
    private void onActionUp() {
        if (mPressedHandle != null) {
            mPressedHandle = null;
            invalidate();
            if (onCropWindowChangedListener != null)
                onCropWindowChangedListener.onCropWindowChanged();
        }
    }
    private OnCropWindowChangedListener onCropWindowChangedListener;

    public void setOnCropWindowChangedListener(OnCropWindowChangedListener onCropWindowChangedListener) {
        this.onCropWindowChangedListener = onCropWindowChangedListener;
    }
