...
public class SearchAccountDynamicItemAdapterAccress extends BaseRecyleAdapter<AccessModel.ListBean.GsTopicVo.GsTopicVoListBean> {
    ...
    @Override
    protected void convert(BaseViewHolder holder, AccessModel.ListBean.GsTopicVo.GsTopicVoListBean item) {
        switch (holder.getItemViewType()) {
            ...
            case TYPE_TEXT:
                ...
                imageHolder.setText(R.id.tv_item_scan_number, String.format("%d人浏览", item.getViewCount()));
                break;
            case TYPE_VIDEO:
                ...
                holder.setText(R.id.tv_item_scan_number, String.format("%d人浏览", item.getViewCount()));
                //处理内容
    ...
    protected int getChildItemViewType(int position) {
        if (_list.get(position).getFileList().size() == 0)
            return TYPE_TEXT;
        int viewType = _list.get(position).getFileList().get(0).getClass1();
        switch (viewType) {
            case 3:
                return TYPE_ACTRICE;
            case 4:
    ...
    class ImageHolder extends BaseViewHolder {
        ...
        public ImageHolder(final Context context, View itemView) {
            ...
            gridAdapter = new SingleImageAdapterAccess(context, width, null);
            ...
            recycle_multiple_img.addOnItemTouchListener(new OnRecycleItemClickListener() {
                ...
                public void onItemClick(BaseRecyleAdapter adapter, View view, int position) {
                    ...
                    for (int i = 0; i < adapter.getList().size(); i++) {
                        AccessModel.ListBean.GsTopicVo.GsTopicVoListBean.FileList model = (AccessModel.ListBean.GsTopicVo.GsTopicVoListBean.FileList) adapter.getList().get(i);
