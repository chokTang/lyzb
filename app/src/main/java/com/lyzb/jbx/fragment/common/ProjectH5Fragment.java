...
import com.szy.yishopcustomer.Activity.GroupBuyActivity;
import com.szy.yishopcustomer.Activity.LoginActivity;
import com.szy.yishopcustomer.Activity.ScanActivity;
import com.szy.yishopcustomer.Activity.ShareActivity;
import com.szy.yishopcustomer.Activity.TakeOutAddressListActivity;
...
public class ProjectH5Fragment extends BaseToolbarFragment {
    ...
    public static ProjectH5Fragment newIntance(String url) {
        return newIntance(url, "");
    }

    public static ProjectH5Fragment newIntance(String url, String title) {
        ProjectH5Fragment fragment = new ProjectH5Fragment();
    ...
    public void onInitView(@Nullable Bundle savedInstanceState) {
        ...
        mView_Hint = findViewById(R.id.view_loadhint);
    ...
    public void onInitData(@Nullable Bundle savedInstanceState) {
        if (!TextUtils.isEmpty(mUrl)) {
            setWebview(getBaseActivity(), mWebView, mProgressBar, mWebView, mButton_Reload, mUrl);
        } else {
            showToast("地址异常,无法访问");
        }
    ...
    public Object getResId() {
        return R.layout.activity_citylife;
    }
    ...
    private static final int PERSON_CARD = 0x533;
    private static final int NEW_URL = 0x5331;
    ...
    public Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                    ...
                    switch (msg.arg1) {
                        case 1://支付宝原生支付回调
                            ...
                            if (TextUtils.equals(resultStatus1, "9000")) {
                                ...
                                startActivity(new Intent(getContext(), GroupBuyPaySuccessActivity.class)
                                ...
                                startActivity(new Intent(getContext(), GroupBuyPayFailActivity.class)
                                        .putExtra(KEY_ORDER, orderId));
                            }
                            break;
                        case 0://支付宝H5支付回调
                ...
                //跳转到新的页面
                case NEW_URL:
                    start(ProjectH5Fragment.newIntance((String) msg.obj));
                    break;
                default:
                    break;
            }
    ...
    public class NativeInterface {
        ...
        @JavascriptInterface
        public void goSmartCardPage(String userId) {
            mMessage = new Message();
            mMessage.what = PERSON_CARD;
            mMessage.obj = userId;
            mHandler.sendMessage(mMessage);
        }
...
//            if (Build.VERSION.SDK_INT < 26) { }
    ...
    @Override
    public void pop() {
        if (getParentFragment() instanceof AccessFragment) {
            ((AccessFragment) getParentFragment()).pop();
        } else {
            super.pop();
        }
    }
    ...
    public void start(ISupportFragment toFragment) {
        if (getParentFragment() instanceof AccessFragment) {
            ((AccessFragment) getParentFragment()).start(toFragment);
        } else {
