...
import com.lyzb.jbx.fragment.me.card.AddGoodFragment;
...
/**
 * @role 企业详情-商城 _fragment
 */

public class CompanyMallLayoutFragment extends BaseFragment<CompanyMallPresenter> implements OnRefreshLoadMoreListener, ICdMallView {
    ...
    private CompanyMallFragment parentFragment = null;
    ...
    public void onInitView(@Nullable Bundle savedInstanceState) {
        ...
        parentFragment = (CompanyMallFragment) getParentFragment();
        ...
        if (parentFragment.getFromType() == 2) {//别人的名片
            ...
            if (App.getInstance().isMeComd) {//是自己的企业
                ...
                if (parentFragment.getCreatorId().equals(App.getInstance().userId)) {
            ...
            public void onClick(View v) {
                if (App.getInstance().isLogin()) {
                    if (addGoodText.getText().toString().trim().equals("发布商品")) {//发布商品
                        childStartForResult(AddGoodFragment.newIntance(parentFragment.getCompanyid()), 1166);
                    } else {//看别人的名片 发布自己的商品
...
//        } else {
        mPresenter.getList(true, parentFragment.getCompanyid());
//        }
...
//                }
    ...
    public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
        mPresenter.getList(false, parentFragment.getCompanyid());
    }
