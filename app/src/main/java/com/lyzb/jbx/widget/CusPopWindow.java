 ...
 * @author wyx
 * @role 自定义pop
 * @time 2018 2018/12/11 11:47
 */

public class CusPopWindow implements PopupWindow.OnDismissListener {
    ...
    public CusPopWindow(Context context) {
        mContext = context;
    }
     ...
     * @return
     */
    public CusPopWindow showAsDropDown(View anchor, int xOff, int yOff) {
    ...
    public CusPopWindow showAsDropDown(View anchor) {
        if (mPopupWindow != null) {
    ...
    public CusPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity) {
        if (mPopupWindow != null) {
     ...
     * @return
     */
    public CusPopWindow showAtLocation(View parent, int gravity, int x, int y) {
        if (mPopupWindow != null) {
    ...
    private PopupWindow build() {
        ...
        if (mWidth != 0) {
            ...
            if (mHeight != 0) {
                ...
                mPopupWindow = new PopupWindow(mContentView, mWidth, ViewGroup.LayoutParams.MATCH_PARENT);
            }
        } else {
            ...
            mPopupWindow.setTouchInterceptor(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if ((event.getAction() == MotionEvent.ACTION_DOWN) && ((x < 0) || (x >= mWidth) || (y < 0) || (y >= mHeight))) {
                        Log.d(TAG, "out side ");
                        Log.d(TAG, "width:" + mPopupWindow.getWidth() + "height:" + mPopupWindow.getHeight() + " x:" + x + " y  :" + y);
                        return true;
    ...
    public static class PopupWindowBuilder {
        ...
        private CusPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context) {
            mCustomPopWindow = new CusPopWindow(context);
        }
