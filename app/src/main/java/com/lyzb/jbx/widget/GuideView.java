        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                ...
                case RECTANGULAR://圆角矩形
                    if (isContain) {
                        oval.left = location[0] - 2;
                        oval.top = center[1] - targetViewHeight / 2 - 2;
                        oval.right = location[0] + targetViewWidth + 2;
                        oval.bottom = center[1] + targetViewHeight / 2 + 2;
                    } else {
            ...
            if (direction != null) {
                ...
                switch (direction) {
                    case TOP:
                        ...
                        guideViewParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
                        break;
                    case BOTTOM:
