...
public class BubbleLayout extends FrameLayout {
    ...
    private void initAttr(TypedArray a) {
        ...
        mLookWidth = a.getDimensionPixelOffset(R.styleable.BubbleLayout_lookWidth, Utils.dpToPx(getContext(), 17F));
        mLookLength = a.getDimensionPixelOffset(R.styleable.BubbleLayout_lookLength, Utils.dpToPx(getContext(), 17F));
        mShadowRadius = a.getDimensionPixelOffset(R.styleable.BubbleLayout_shadowRadius, Utils.dpToPx(getContext(), 3.3F));
        mShadowX = a.getDimensionPixelOffset(R.styleable.BubbleLayout_shadowX, Utils.dpToPx(getContext(), 1F));
        mShadowY = a.getDimensionPixelOffset(R.styleable.BubbleLayout_shadowY, Utils.dpToPx(getContext(), 1F));
        mBubbleRadius = a.getDimensionPixelOffset(R.styleable.BubbleLayout_bubbleRadius, Utils.dpToPx(getContext(), 7F));
        mBubblePadding = a.getDimensionPixelOffset(R.styleable.BubbleLayout_bubblePadding, Utils.dpToPx(getContext(), 8));
