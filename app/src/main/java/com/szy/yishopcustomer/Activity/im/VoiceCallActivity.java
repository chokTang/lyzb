...
//		DemoHelper.getInstance().isVoiceCalling = true;
        ...
        hangupLine = (LinearLayout) findViewById(R.id.lin_hangup_call);
        ...
        //对方 头像
        ImageView img_head = (ImageView) findViewById(R.id.swing_card);
        ...
        shopHead = getIntent().getStringExtra("shopHeadUrl");

        GlideApp.with(this)
                .load(Utils.setImgNetUrl(Api.API_CITY_HOME_MER_IMG_URL, shopHead))
                .centerCrop()
                .error(R.mipmap.img_empty)
                .into(img_head);

        isInComingCall = getIntent().getBooleanExtra("isComingCall", false);
        nickTextView.setText(shopName);
        if (!isInComingCall) {// outgoing call
            ...
            hangupLine.setVisibility(View.VISIBLE);
    ...
    private boolean connected, accepted;
