...
public class SortMoreActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_more_sort_seach:
                startActivity(new Intent(this, SortSeachActivity.class));
                break;
        }
    }
        ...
        requestQueue.add(HttpWhat.HTTP_MORE_SORT.getValue(), request, new OnResponseListener<String>() {
            ...
            public void onSucceed(int what, Response<String> response) {
                ...
                if (response.responseCode() == 200) {
                    ...
                    Toast.makeText(SortMoreActivity.this, R.string.data_error, Toast.LENGTH_SHORT).show();
                }
            }
