...
import com.szy.yishopcustomer.Util.im.Utils;
...
public class RecorderVideoActivity extends BaseActivity implements
	...
	private final static int REQUEST_CODE = 3556;
	...
	public void onClick(View view) {
		switch (view.getId()) {
			...
			case R.id.recorder_start:
				// start recording
				if (PermissionUtils.hasPermission(this, new String[]{"android.permission.RECORD_AUDIO", "android.permission.WRITE_EXTERNAL_STORAGE"})) {
					if (!startRecording())
						return;
					...
					PermissionUtils.requestPermission(this,REQUEST_CODE,new String[]{"android.permission.RECORD_AUDIO", "android.permission.WRITE_EXTERNAL_STORAGE"});
				}
