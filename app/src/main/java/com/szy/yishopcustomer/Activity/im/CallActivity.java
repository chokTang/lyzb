...
//                        }
    ...
    protected void saveCallRecord() {
        ...
        message.setAttribute(EaseConstant.EXTRA_FROM_NICKNAME, username);
        String userLogo = Utils.getSharedPreferences(this, Utils.urlOfImage(App.getInstance().headimg));
        message.setAttribute(EaseConstant.EXTRA_FROM_HEADER, userLogo);
...
//            message.setAttribute(EaseConstant.EXTRA_FROM_NICKNAME, shopName);
//            message.setAttribute(EaseConstant.EXTRA_FROM_HEADER, shopHead);
//        }
        ...
        String em_id = SharedPreferencesUtils.getParam(this, Key.IM_USERNAME.name(), "").toString();
        //环信帐号id
        message.setAttribute(EaseConstant.EXTRA_FROM_USERID, em_id);
        message.setAttribute(EaseConstant.EXTRA_FROM_HEADER, Utils.urlOfImage(App.getInstance().headimg));

        //对方信息
        message.setAttribute(EaseConstant.EXTRA_TO_NICKNAME, shopName);
        message.setAttribute(EaseConstant.EXTRA_TO_HEADER, shopHead);
        message.setAttribute(EaseConstant.EXTRA_TO_USERID, username);
