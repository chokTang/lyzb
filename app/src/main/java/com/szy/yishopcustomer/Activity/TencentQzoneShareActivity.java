...
public class TencentQzoneShareActivity extends YSCBaseActivity implements IUiListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("TTT-QZONE", JSON.toJSONString(shareData));
        ArrayList<String> images = new ArrayList<>();
        images.add(Utils.urlOfImage(shareData.get(3)));
        TencentQzoneShareActivity.mTencent = TencentUtils.shareToQZone(
                TencentQzoneShareActivity.this, shareData.get(0), shareData.get(1),
                shareData.get(2), images, TencentQzoneShareActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Tencent.onActivityResultData(requestCode, resultCode, data, TencentQzoneShareActivity.this);
    }
