...
/**
 * Created by 李威 on 17/3/11.
 * All Rights Reserved By 秦皇岛商之翼网络科技有限公司.
 */
public class SelectAddressSubPoiAdapter extends RecyclerView.Adapter {
    ...
    public SelectAddressSubPoiAdapter() {
        this.data = new ArrayList<>();
    }

    public SelectAddressSubPoiAdapter(List<Object> data) {
        this.data = data;
    }

    public RecyclerView.ViewHolder createPoiNearListViewHolder(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout
                .item_select_address_subpoi, parent, false);
