 ...
 */
public class ShopStreetCategoryLevelOneAdapter extends RecyclerView.Adapter<TabViewHolder> {
    public View.OnClickListener onClickListener;
    public List<CategoryModel> mData;

    public ShopStreetCategoryLevelOneAdapter(List<CategoryModel> data) {
        this.mData = data;
    }
    ...
    public TabViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout
                .item_shop_street_left_tab, parent, false);
    ...
    public void onBindViewHolder(TabViewHolder viewHolder, int position) {
        ...
        Utils.setExtraInfoForTag(viewHolder.titleTextView, Integer.parseInt(item.getCatId()));
