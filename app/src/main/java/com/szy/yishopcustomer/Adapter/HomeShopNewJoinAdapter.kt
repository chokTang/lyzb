...
class HomeShopNewJoinAdapter(layoutResId: Int) : BaseQuickAdapter<HomeShopAndProductBean.ShopNewBean, BaseViewHolder>(layoutResId) {

    override fun convert(helper: BaseViewHolder?, item: HomeShopAndProductBean.ShopNewBean?) {
