...
class HomeShopNetHotAdapter(layoutResId: Int) : BaseQuickAdapter<HomeShopAndProductBean.ShopHotBean, BaseViewHolder>(layoutResId) {

    override fun convert(helper: BaseViewHolder?, item: HomeShopAndProductBean.ShopHotBean?) {
