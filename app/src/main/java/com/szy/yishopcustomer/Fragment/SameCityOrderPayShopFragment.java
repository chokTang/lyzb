...
public class SameCityOrderPayShopFragment extends YSCBaseFragment {

    private View mView;
    private CommonRecyclerView recy_same_city_order;

    private final static int RERESH = 0x257;
    private final static int ONLOADMORE = 0x258;
    private OrderShopListAdapter mAdapter;
    private int pageIndex = 1;
    private int pageSize = 10;
    private int type = 5;// 0(or undefined):全部;1:待付款;2:待使用;3:待评价;4:退款,5已完成;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (mView == null) {
            mView = inflater.inflate(R.layout.fragment_samecity_order_payshop, container, false);
        }
     ...
     * @param isRefresh
     */
    public void getOrderList(int type, final boolean isRefresh) {
