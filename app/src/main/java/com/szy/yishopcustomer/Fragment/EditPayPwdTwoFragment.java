 ...
 */
public class EditPayPwdTwoFragment extends YSCBaseFragment implements TextWatcher {
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (mPassword.length() != 0) {
            if(mPassword.length()>=6 && mPassword.length()<=20){
                ...
                mTip.setText("新余额支付密码长度为6-20个字符，建议由字母、数字和符号两种以上。");
            }
        } else {
            mTipLayout.setVisibility(View.VISIBLE);
            mTip.setText("请输入新余额支付密码");
        }
    }
    ...
    private void changePassword() {
        CommonRequest request = new CommonRequest(Api.API_SECURITY_EDIT_SURPLUS_PASSWORD, HttpWhat
                .HTTP_POST_NEW_PASSWORD.getValue(), RequestMethod.POST);
        request.add("EditSurplusPasswordModel[surplus_password]", mPassword);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        StepBean stepBean1 = new StepBean("设置余额支付密码", 0);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutId = R.layout.fragment_edit_pay_pwd_two;
    }
            ...
            case HTTP_POST_NEW_PASSWORD:
                HttpResultManager.resolve(response, ResponseCommonModel.class, new HttpResultManager.HttpResultCallBack<ResponseCommonModel>() {
                    ...
                    public void onSuccess(ResponseCommonModel back) {
                        ...
                        if (mListener != null) {
                            mListener.onFinish(EditPayPwdTwoFragment.this);
                        }
                    }
                },true);
                break;
    ...
    public static EditPayPwdTwoFragment newInstance() {
        EditPayPwdTwoFragment fragment = new EditPayPwdTwoFragment();
        return fragment;
    }
