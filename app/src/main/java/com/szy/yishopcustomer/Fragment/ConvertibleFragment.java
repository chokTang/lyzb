 ...
 */
public class ConvertibleFragment extends YSCBaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutId = R.layout.fragment_convertible;
    ...
    private void refreshSucceed(String response) {
        ...
        HttpResultManager.resolve(response, IntegralMallListModel.class, new HttpResultManager
                .HttpResultCallBack<IntegralMallListModel>() {
            @Override
    ...
    private void changeButtonStyles() {
        ...
        fragment_integral_sort_exchange_amount_imageview.setImageResource(R.mipmap
                .bg_arrow_default);
        ...
        switch (sort) {
            ...
            case 2:
                ...
                if (sort_order[2]) {
                    fragment_integral_sort_integral_value_imageview.setImageResource(R.mipmap
                            .bg_arrow_up);
                } else {
                    fragment_integral_sort_integral_value_imageview.setImageResource(R.mipmap
                            .bg_arrow_down);
            ...
            case 3:
                ...
                if (sort_order[3]) {
                    fragment_integral_sort_shelf_time_imageview.setImageResource(R.mipmap
                            .bg_arrow_up);
                } else {
                    fragment_integral_sort_shelf_time_imageview.setImageResource(R.mipmap
                            .bg_arrow_down);
