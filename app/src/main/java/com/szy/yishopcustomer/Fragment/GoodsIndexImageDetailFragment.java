...
//    private String goods_id;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutId = R.layout.fragment_goods_index_image_detail;
        initId();
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        mWebView.addJavascriptInterface(new com.szy.yishopcustomer.View
                .JavascriptInterface(getActivity()), MyWebViewClient.FLAG_IMAGE);
...
//                    @Override
//                    public void onSuccess(ResponseGoodsModel back) {
//                        sku_id = back.data.goods.sku_id;
//                        getGoodsDesc(sku_id);
//                    }
//                }, true);
                break;
    ...
    void updateGoodsDesc(String source) {
        ...
        if (model.need_load) {
            ...
            if (model.is_jd) {
                ...
                String mb_desc = com.alibaba.fastjson.JSON.parseObject(source).getString("mobile_desc");
                if (!TextUtils.isEmpty(mb_desc)) {
                    mWebView.loadData(Utils.imgContentSetMaxHeight(mb_desc), "text/html; charset=UTF-8", null);
                } else {
                    mWebView.loadData(Utils.imgContentSetMaxHeight(model.pc_desc), "text/html; charset=UTF-8", null);
                }
