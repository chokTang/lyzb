 ...
 */
public class YSOStoreRegionListFlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    public YSOStoreRegionListFlowLayoutManager(boolean isFullyLayout) {
    ...
    public RecyclerView.LayoutParams generateDefaultLayoutParams() {
        return new RecyclerView.LayoutParams(RecyclerView.LayoutParams.WRAP_CONTENT, RecyclerView
