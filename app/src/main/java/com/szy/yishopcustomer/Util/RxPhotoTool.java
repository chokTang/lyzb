...
import static com.szy.yishopcustomer.Util.RxFileTool.getDataColumn;
import static com.szy.yishopcustomer.Util.RxFileTool.isDownloadsDocument;
import static com.szy.yishopcustomer.Util.RxFileTool.isExternalStorageDocument;
import static com.szy.yishopcustomer.Util.RxFileTool.isGooglePhotosUri;
import static com.szy.yishopcustomer.Util.RxFileTool.isMediaDocument;
...
public class RxPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            Utils.makeToast(context, "请先获取写入SDCard权限");
        } else {
